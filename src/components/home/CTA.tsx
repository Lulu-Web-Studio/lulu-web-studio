    ...
    return (
        <section className="bg-white min-h-[80vh] flex items-center justify-center rounded-t-[50px] py-24 pb-40 relative z-10 -mt-12 sm:-mt-16 md:-mt-24 lg:-mt-28">
            <div className="w-5/6 mx-auto text-center">
                {/* Section Eyebrow */}
                <p className="uppercase text-md text-neutral-500 mb-6">
                    Ready to Get Started?
                </p>

                {/* Main Heading */}
                <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-neutral-900 mb-8 leading-tight">
                    Let&apos;s Build Something <br />
                    <span className="text-neutral-600">Amazing Together</span>
                </h2>

                {/* Supporting Text */}
                <p className="text-neutral-700 leading-relaxed text-lg md:text-xl max-w-3xl mx-auto mb-12">
